<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div id="content-statistics" class="tab-content bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-blue-50 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900">{{ $project->datasets->count() }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-green-50 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900">{{ $project->transactions->count() }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-purple-50 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <p class="text-sm font-medium text-gray-500">Association Rules</p>
                                    <p class="text-2xl font-bold text-gray-900">{{ $project->rules->count() }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">Item Count</th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($transactions as $transaction)
                                            ...
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4 text-sm text-center text-gray-900">{{ count($items) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                        ...
                        <div class="p-6">
                            ...
                            @if($project->rules->count() >= 10)
                                <div class="mt-4 text-center">
                                    <a href="{{ route('apriori.results', $project) }}" class="text-blue-600 hover:text-blue-900 font-medium">
                                        View All Rules →
                                    </a>
                                </div>
                            @endif
                ...
                @else
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-center text-gray-500">
                            ...
                            <p class="mt-2">No association rules found</p>
                            <p class="text-sm mt-1">Run Apriori analysis to generate rules</p>
                        </div>
                    </div>
                @endif
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Get saved tab or default to statistics
            const savedTab = localStorage.getItem('activeTab') || 'statistics';
            switchTab(savedTab);
        });
